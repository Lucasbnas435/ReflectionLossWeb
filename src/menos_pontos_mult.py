...
def plotar_menos_pontos_multicamadas(samples, arquivo_saida_original, hash_arquivo1, divisor_quantidade_pontos):
...
# Leitura do arquivo-----------------------------------
    ...
    '<button type="submit">Retornar ao gráfico multicamadas</button>' + \
    '</form>' + \
    '<footer>' + \
